...
export default function ChartPathProvider({ data: providedData, children, lineDot }) {
	...
	const dotStyle = useAnimatedStyle(
		() => ({
			...
			transform: [
				...
				{ translateY: lineDot ? 0 : values.positionY.value + 10 }, // TODO temporary fix for clipped chart
				{ scale: lineDot ? 1 : values.dotScale.value },
			],
